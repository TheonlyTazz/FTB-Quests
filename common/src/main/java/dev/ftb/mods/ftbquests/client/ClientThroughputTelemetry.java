...
public class ClientThroughputTelemetry {
	...
	public static void update(UUID teamId, long taskId, long currentRate, long requiredRate, int windowTicks, int graceTicks, int belowRateTicks, Identifier resourceTypeId) {
	...
	public record Entry(long currentRate, long requiredRate, int windowTicks, int graceTicks, int belowRateTicks, Identifier resourceTypeId, long receivedTick) {
